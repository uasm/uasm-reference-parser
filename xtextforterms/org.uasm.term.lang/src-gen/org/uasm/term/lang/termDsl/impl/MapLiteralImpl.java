 ...
 * </p>
 * <ul>
 *   <li>{@link org.uasm.term.lang.termDsl.impl.MapLiteralImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapLiteralImpl extends LiteralImpl implements MapLiteral
{
  ...
  {
    return TermDslPackage.Literals.MAP_LITERAL;
  }
  ...
  public EList<Literal> getLiteral()
  {
    if (literal == null)
    {
      literal = new EObjectContainmentEList<Literal>(Literal.class, this, TermDslPackage.MAP_LITERAL__LITERAL);
    }
    return literal;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TermDslPackage.MAP_LITERAL__LITERAL:
