 ...
 * </p>
 * <ul>
 *   <li>{@link org.uasm.term.lang.termDsl.impl.ListLiteralImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListLiteralImpl extends LiteralImpl implements ListLiteral
{
  ...
  {
    return TermDslPackage.Literals.LIST_LITERAL;
  }
  ...
  public EList<Literal> getLiteral()
  {
    if (literal == null)
    {
      literal = new EObjectContainmentEList<Literal>(Literal.class, this, TermDslPackage.LIST_LITERAL__LITERAL);
    }
    return literal;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TermDslPackage.LIST_LITERAL__LITERAL:
